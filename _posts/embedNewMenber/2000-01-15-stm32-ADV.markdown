...
**经过编译器预处理之后的代码如下，所有的宏展开了，这里把相关的宏的定义放到了注释中，方便查看**
...
- **`AHBPERIPH_BASE`**：AHB 总线外设基地址，`0x40000000 + 0x20000 = 0x40020000`。
...
- **`APB2PERIPH_BASE`**：APB2 总线外设基地址，`0x40000000 + 0x10000 = 0x40010000`。
